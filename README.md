...
Proyecto final web individual, tema #13: control de estacionamiento. El Hito 1 cubre la base tecnica y el modelado inicial del dominio.

## Stack

- Backend: Node.js, Express, Sequelize, PostgreSQL.
- Frontend: Vite + React.
- Base de datos: PostgreSQL local o Railway en produccion.
- Migraciones: Sequelize CLI.

## Requisitos desarrollados en Hito 1
...
| GEN-03 | desarrollado | Conexion Sequelize por `DATABASE_URL` y migraciones iniciales. |
...
La matriz completa esta en [`matriz-avance-hito-1.md`](matriz-avance-hito-1.md).
...
- npm 10 o superior.
- PostgreSQL 16 o Docker para levantar la base local.
...
|----------|----------|-----------|------------|
| `DATABASE_URL` | API | URL de PostgreSQL local. | Variable del servicio API en Railway. |
...
- `users`: base para autenticacion futura.
...
Endpoints disponibles en Hito 1:
...
- Hito 2: registro, login, middleware JWT, primeras pantallas web de dominio.
